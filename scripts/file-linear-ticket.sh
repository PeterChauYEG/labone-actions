...
# via ops' own adaptation of the same script.
...
# LAB team label IDs, from ops' configs/linear-labels.json — hardcoded here
# since the ops harness config isn't checked out on this repo's GHA runner
# workspace.
